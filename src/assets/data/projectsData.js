export default [
  ...
  {
    title: 'Tasks board',
    technologies: 'HTML, TypeScript, React.js, Styled components',
    description: 'A simple yet powerful board management application designed for efficient task organization. Incorporates an intuitive drag-and-drop interface, which enhances flexibility.',
    github: 'https://github.com/Tapio-adro/tasks-board',
    link: 'https://project-board-00.netlify.app/',
    layout: '',
    imgIndex: 5
  },
  {
